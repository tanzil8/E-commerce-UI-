  ...
  return (
    ...
    <div className="bg-black mt-24">
      <div className="max-w-screen-lg px-4 sm:px-6 text-gray-300 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        <div className="p-5">
          <h3 className="font-extrabold text-4xl text-white">Company Name</h3>
        </div>
        <div className="p-5">
          <div className="text-2xl  uppercase text-white font-bold">
            Resources
          </div>
          <a className="text-1xl my-3 block" href="/#">
        ...
        <div className="p-5">
          ...
          <a className="text-1xl my-3 block" href="/#">
            Help Center <span className="text-white text-xs p-1" />
          </a>
          <a className="text-1xl my-3 block" href="/#">
    ...
    <div className="bg-black pt-2">
      <div
        className="flex pb-5 px-3 m-auto pt-5 border-t text-gray-300 text-sm flex-col
  max-w-screen-lg items-center"
      >
        <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
          <a href="/#" className="w-6 mx-1">
            <svg
              className="fill-current cursor-pointer text-gray-500 hover:text-white"
              width="100%"
              height="100%"
              viewBox="0 0 24 24"
              version="1.1"
